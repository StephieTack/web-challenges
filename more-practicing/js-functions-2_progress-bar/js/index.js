...
function calculateScrollPercentage() {
  ...
  return (actualPosition / (websiteHeight - windowHeight)) * 100;
}
// console.log(calculateScrollPercentage());

// längere Variante mit Zwischenspeichern einer Konstanten in der die Funktion gespeichert wird:
// document.addEventListener("scroll", () => {
//   const scrollPositionReturn = calculateScrollPercentage();
//   progressBar.style.width = scrollPositionReturn + "%";
// });
